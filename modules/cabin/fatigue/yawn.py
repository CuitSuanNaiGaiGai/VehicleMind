...
class YawnDetector:
    ...
    def __init__(
        ...
        self.min_open_ms = int(min_open_seconds * 1000)
    ...
    def update(
        ...
        if mouth_open:
            ...
            open_duration_ms = timestamp_ms - self._open_start_ms

            if open_duration_ms >= self.min_open_ms and not self._event_triggered:
                self.yawn_count += 1
        ...
        return YawnResult(
            ...
            open_duration=(open_duration_ms / 1000.0),
            is_yawning=(mouth_open and open_duration_ms >= self.min_open_ms),
